...
void bluetoothTask(void* pvParameters) {
  SerialBT.begin(btServerName);  // Start Bluetooth server with the name "ESP32_BT_Server"
  ...
  while (1) {
    ...
    vTaskDelay(20 / portTICK_PERIOD_MS);  // Delay to prevent overwhelming the ESP32
  }
}
